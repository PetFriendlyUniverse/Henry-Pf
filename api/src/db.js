...
const { Users, Invoices, Products, Invoices_Products, Stores, Favorites } =
  sequelize.models;

Invoices.belongsToMany(Products, { through: Invoices_Products });
Products.belongsToMany(Invoices, { through: Invoices_Products });
