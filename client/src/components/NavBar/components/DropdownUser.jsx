...
function DropdownUser() {
  ...
  return (
    <div className="flex flex-col py-3 lg:w-full">
      ...
      <ul
        // ref={userMenu}
        className="invisible ml-7 list-none overflow-hidden border border-cornflowerblue py-1 text-left text-cornflowerblue shadow-lg peer-focus:visible lg:absolute lg:top-12 lg:z-50 lg:ml-0 lg:w-40 lg:bg-russianviolet lg:p-2 xl:right-6 2xl:right-5 2xl:w-1/3  "
      >
        <li>
