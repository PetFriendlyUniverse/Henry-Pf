    ...
    <>
      ...
      <div class="mt-4 flex items-center">
        ...
        <div class="mx-4 h-5 w-2/4 rounded bg-gray-200 dark:bg-gray-700">
          <div class="h-5 w-[70%] rounded bg-yellow-400"></div>
        </div>
        <span class="text-sm font-medium text-blue-600 dark:text-blue-500">
          70%
        </span>
      ...
      <div class="mt-4 flex items-center">
        ...
        <div class="mx-4 h-5 w-2/4 rounded bg-gray-200 dark:bg-gray-700">
          <div class="bg-yellow-400w-[17%] h-5 rounded"></div>
        </div>
        <span class="text-sm font-medium text-blue-600 dark:text-blue-500">
          17%
        </span>
      ...
      <div class="mt-4 flex items-center">
        ...
        <div class="mx-4 h-5 w-2/4 rounded bg-gray-200 dark:bg-gray-700">
          <div class="bg-yellow-400w-[8%] h-5 rounded"></div>
        </div>
        <span class="text-sm font-medium text-blue-600 dark:text-blue-500">
          8%
        </span>
      ...
      <div class="mt-4 flex items-center">
        ...
        <div class="mx-4 h-5 w-2/4 rounded bg-gray-200 dark:bg-gray-700">
          <div class="bg-yellow-400w-[4%] h-5 rounded"></div>
        </div>
        <span class="text-sm font-medium text-blue-600 dark:text-blue-500">
          4%
        </span>
      ...
      <div class="mt-4 flex items-center">
        ...
        <div class="mx-4 h-5 w-2/4 rounded bg-gray-200 dark:bg-gray-700">
          <div class="bg-yellow-400w-[1%] h-5 rounded"></div>
        </div>
        <span class="text-sm font-medium text-blue-600 dark:text-blue-500">
          1%
        </span>
