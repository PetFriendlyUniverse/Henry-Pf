...
export default function HomeShop() {
  return (
    <div className="scrollbar scrollbar-rounded-xl scrollbar-thumb-blue-500 scrollbar-track-blue-300  w-full pt-24 lg:flex lg:min-h-screen lg:flex-col lg:gap-12  xl:items-center">
