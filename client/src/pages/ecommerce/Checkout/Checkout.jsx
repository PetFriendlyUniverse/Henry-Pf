function Checkout() {
  return (
    <div className="flex h-[90vh] w-screen items-center justify-center bg-slate-200">
      <div className="my-4 flex h-screen max-h-[80vh] min-w-[60vw] flex-row items-center justify-center ">
        ...
        <div className=" flex h-4/6 w-2/6 flex-col self-start ">
          ...
          <div className="m-4 flex h-5/6 w-full flex-col items-center justify-between  p-2">
            ...
            <button
              type="button"
              className=" w-full self-end rounded-lg bg-green-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
            >
              Finalizar Compra
            </button>
          </div>
