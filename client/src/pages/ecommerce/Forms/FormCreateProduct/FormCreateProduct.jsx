  ...
  return (
    ...
    <div className="flex min-h-screen w-full justify-center bg-[url('https://petfood.com.ar/img/cms/symphony.png')] pt-28 pb-10 ">
      ...
      <form
        ...
        className="mt-10 flex max-h-screen w-full flex-col items-center   rounded-xl  bg-gradient-to-r from-cornflowerblue to-russianviolet p-3 drop-shadow-2xl md:w-3/5 lg:h-auto "
      >
