  ...
  return (
    <div className="flex h-screen justify-center py-28">
      ...
      >
        ...
        <div className="group relative z-0 mb-6 h-11 w-full">
          <select class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
        ...
        <div className="group relative z-0 mb-6 h-11 w-full">
          <select class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
            <option hidden>Selecciona una Localidad</option>
            <option value="bsas">Mar del Plata</option>
          </select>
        </div>
        <div className="group relative z-0 mb-6 h-11 w-full">
          <input
