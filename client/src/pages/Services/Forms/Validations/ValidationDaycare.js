export const validationDaycare = (property, value) => {
  ...
  if (property === "name" && !value) {
    error.name = "Debe ingresar un nombre para su guarderia";
  } else if (property === "name") {
    if (!stringRegex.test(value)) {
      error.name =
        "Por favor ingrese el nombre de la guarderia sin numeros o signos";
  ...
  if (property === "phone" && !value) {
    error.phone = "Debe ingresar un numero telefonico para su guarderia";
  } else if (property === "phone") {
    if (!numberRegex.test(value)) {
      error.phone =
        "Por favor ingrese un telefono para la guarderia sin letras o signos";
  ...
  if (property === "province" && !value) {
    ...
    if (!stringRegex.test(value)) {
      error.province =
        "Por favor ingrese el nombre de la provincia donde se encuentra su guarderia sin numeros o signos";
    } else if (value.length > 30) {
  ...
  if (property === "locality" && !value) {
    ...
    if (!stringRegex.test(value)) {
      error.locality =
        "Por favor ingrese el nombre de la localidad donde se encuentra su guarderia sin numeros o signos";
    } else if (value.length > 30) {
