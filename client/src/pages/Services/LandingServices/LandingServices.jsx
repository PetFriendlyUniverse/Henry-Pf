...
function LandingServices() {
  ...
  return (
    <>
      <header className="clip-header relative flex w-full flex-col overflow-hidden  bg-cover bg-fixed bg-center bg-no-repeat pt-0 text-black sm:h-[350px] lg:h-[600px] lg:min-h-[400px]  xl:min-h-[400px]">
        <img
          src={universe}
          alt=""
